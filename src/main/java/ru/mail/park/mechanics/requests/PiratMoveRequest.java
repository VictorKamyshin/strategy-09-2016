...
public class PiratMoveRequest {
    ...
    public PiratMoveRequest(@JsonProperty("piratId") Integer piratId,
        ...
        this.targetCellX = targetCellIndex % GameBoard.BOARDHIGHT; //потому что к нам пришел индекс клетки с фронта
        this.targetCellY = targetCellIndex / GameBoard.BOARDHIGHT; // а мы работаем в двумерных координатах
    }
